...
###  Цели
  ...
  + Часть 3.  Настроите отслеживание линка через технологию IP SLA.(только для IPv4)
  + Часть 4.  Настройте для офиса Лабытнанги маршрут по-умолчанию.
  + Часть 5.  План работы и изменения зафиксированы в документации .
...
Настроим оспф в офисах, использовать будем ptp соединение.
Аналогично сделаем на остальных устройствах.
...
Для Лабытанги установим маршрут по умолчанию на R25 

![](./imgs/5.png) 


Для AS 2042 на R18 выполним балансироваку траффика, через роут мапы.
Будем делить трафик по вланам.

![](./imgs/6.png) 
![](./imgs/7.png) 


Настроим ip sla на R18 для теста доступа соседских портов
